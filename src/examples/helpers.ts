/**
 * Helper Examples
 * - Dialog: Dialog with data binding
 * - Clipboard: Copy to clipboard
 * - FilePicker: Select file from system
 * - ProgressWindow: Show progress notification
 * - VTable: Virtual table (see preferences)
 */

export async function dialogExample() {
...
export async function filePickerExample() {
...
export function progressWindowExample() {
...
export function vtableExample() {
  ztoolkit.getGlobal("alert")(
    "See src/examples/basic.ts - registerPrefsScripts",
  );
}
